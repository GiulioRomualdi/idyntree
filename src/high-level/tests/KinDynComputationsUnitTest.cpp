...
void testLinearAngularMomentumBiasAcc(KinDynComputations & dynComp)
{
    ...
    std::cerr << "centroidal_momentum_rate_of_change_numerical " << centroidal_momentum_rate_of_change_numerical.toString() << std::endl;
    std::cerr << "centroidal_momentum_rate_of_change_evaluated " << centroidal_momentum_rate_of_change_evaluated.toString() << std::endl;

    ASSERT_EQUAL_VECTOR_TOL(centroidal_momentum_rate_of_change_numerical, centroidal_momentum_rate_of_change_evaluated, 1e-4);
}
